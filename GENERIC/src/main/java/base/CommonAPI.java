...
public class CommonAPI {
    ...
    public static String sauceUserName = "afrajahan";
    public static String sauceKey = "e0083f6f-6d7b-4346-ac98-647226e4906c";
   ...
   public WebElement getElementByLinkText(String locator) {
    ...
    public void dragAnDropByXpaths(String fromLocator, String toLocator) {
        Actions actions = new Actions(driver);
        WebElement from = getElementByXpath(fromLocator);
        WebElement to = getElementByXpath(toLocator);
    ...
    public void waitUntilSelectable(String locator, int seconds) {
        WebDriverWait webDriverWait = new WebDriverWait(driver, seconds);
        webDriverWait.until(ExpectedConditions.elementToBeSelected(getElementByXpath(locator)));
    }
